...
@property (copy, nonatomic) ITRecordedVideo recordedVideo;
...
- (void)setFlashMode:(ITFlashMode)flashMode {
    ...
    switch (flashMode) {
        ...
        case ITFlashModeOn:
            ...
            break;
        case ITFlashModeAuto:
            self.recorder.flashMode = SCFlashModeAuto;
            break;
        case ITFlashModeLight:
