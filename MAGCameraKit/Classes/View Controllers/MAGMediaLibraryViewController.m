...
@interface MAGMediaLibraryViewController () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation MAGMediaLibraryViewController
...
- (void)itemDidSelect:(PHAsset *)asset {
    ...
    if (asset.duration <= self.maxVideoDuration) {
        [self exportMediaAsset:asset completion:^(MAGRecordSession *item) {
...
- (void)exportMediaAsset:(PHAsset *)asset completion:(nonnull void(^)(MAGRecordSession *item))completion {
    
    MAGRecordSession *mediaItem = [MAGRecordSession new];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MAGMediaAssetCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MAGMediaAssetCell class]) forIndexPath:indexPath];
