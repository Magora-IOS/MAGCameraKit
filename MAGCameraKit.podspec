...
Pod::Spec.new do |s|
  s.name             = 'MAGCameraKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MAGCameraKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Stepanov Evgeniy/MAGCameraKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Stepanov Evgeniy' => 'stepanov@magora.systems' }
  s.source           = { :git => 'https://github.com/Stepanov Evgeniy/MAGCameraKit.git', :tag => s.version.to_s }
